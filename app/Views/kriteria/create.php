...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3">Form Tambah Kriteria</h2>
            <form action="/kriteria/save" method="post">
                <?= csrf_field(); ?>
                <div class="form-group row">
                    <label for="spk_kriteria" class="col-sm-2 col-form-label">SPK</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('spk_kriteria')) ? 'is-invalid' : ''; ?>" id="spk_kriteria" placeholder="Masukkan SPK" name="spk_kriteria" autofocus value="<?= old('spk_kriteria'); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_kriteria" placeholder="Masukkan Nama Kriteria" name="nama_kriteria" value="<?= old('nama_kriteria'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="float" class="form-control" id="bobot_kriteria" placeholder="Masukkan Bobot Kriteria" name="bobot_kriteria" value="<?= old('bobot_kriteria'); ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-10">
